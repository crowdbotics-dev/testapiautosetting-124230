...
## Project Structure
    ...
    ├── testapiautosetting_124230  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124230`
...
2. Clone this repo and `cd testapiautosetting_124230`
